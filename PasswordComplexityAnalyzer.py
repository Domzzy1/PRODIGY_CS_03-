...
def analyze_password():
    ...
    if length < 6:
        ...
        messagebox.showwarning("Warning", "Password is too short! Must be at least 6 characters long.")
        return
    elif length < 10:
...
try:
    ...
    print("Icon file not found or failed to load. Using default Tkinter icon.")
